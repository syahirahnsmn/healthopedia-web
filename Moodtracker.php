...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="moodanalysestyle.css">
        ...
        <div class="row">
          <div class="col-sm-12 jumbotron-fluid border shadow" style="padding: 20px; margin-top: 25px;">
            ...
            <form id="moodForm" method="POST">
              ...
              <button type="submit" name="save" class="add-btn btn btn-success float-right" data-toggle="modal" data-target="#exampleModalCenter" value="Analyse Mood">Analyse Mood</button>
              ...
              <ul class="list-group">
               ...
               if($result-> num_rows > 0){
                   while($row = $result-> fetch_assoc()){
                       echo"<li class=\"list-group-item d-flex justify-content-between align-items-center\">" . "<em>" . $row["dateinput"] . "</em><strong>Depression: </strong> <em>"
                       . $row["depression"] . "</em><strong>Depression: </strong> <em>" . $row["elevated"] . "</em><strong>Depression: </strong><em>" . $row["anxiety"] . 
                       "</em> <strong>Depression: </strong> <em>" . $row["irritability"] . "</em> <a href=\"delete-mood.php?id={$row['id']}\"><i class=\"fa fa-trash\" name=\"delete\"></i></a> </li>";
                   }
               }
               ?> 
