                ...
                <div class="posts">
                    ...
                    <div class="post-content">
                        ...
                        <div class="post-title">
                            ...
                            <a href="GreadAnxiety.php"><button class="readMorebtn">Read More &nbsp;<i class="fa fa-arrow-right" aria-hidden="true"></i></button></a>
                        </div>
                    </div>
                    ...
                    <ul class="pagination">
                        ...
                        <li><a href="GsecPage.php" class="prev"><i class="fa fa-chevron-right" aria-hidden="true"></i></a></li>
                    </ul>
                </div>
                <aside class="sidebar">
                    <div class="category">
