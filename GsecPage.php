                ...
                <div class="posts">
                    ...
                    <div class="post-content">
                        ...
                        <div class="post-title">
                            ...
                            <a href="GreadDisconnect.php"><button class="readMorebtn">Read More &nbsp;<i class="fa fa-arrow-right" aria-hidden="true"></i></button></a>
                        </div>
                    </div>
                    <hr>
                    <div class="post-content">
                   ...
                   <ul class="pagination">
                        <li><a href="GArticle.php"><i class="fa fa-chevron-left" aria-hidden="true"></i></a></li>
                        ...
                        <li><a href="GthirdPage.php" class="prev"><i class="fa fa-chevron-right" aria-hidden="true"></i></a></li>
                    </ul>
                </div>
                <aside class="sidebar">
                    <div class="category">
