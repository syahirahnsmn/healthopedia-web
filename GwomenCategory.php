            ...
            <div class="content">
                <div class="posts">
                    ...
                    <div class="post-content">
                        <img src="img/women health.jpg" width="640" height="408" alt="">
                        <div class="post-title">
                            <a><b>What Do You Want to Know About Women’s Health?</b></a>
                            <p>Healthy habits are the best way to avoid disease, prolong your life, and live more happily. But in the chaos of a woman’s daily life, healthy living may take back seat to chores, work, busy schedules, and more. Take these simple steps toward a longer, healthier life.</p>
                            <a href="GreadWomenHealth.php"><button class="readMorebtn">Read More &nbsp;<i class="fa fa-arrow-right" aria-hidden="true"></i></button></a>
                        </div>
                    </div>
